...
class KaikonExpandedPageSeeder extends Seeder
{
    ...
    {
        DB::table('expanded_pages')->insert(array('id' => '1','route_name' => 'member','title' => '管理人','title_en' => '管理人','body' => <<<EOM
        ...
        DB::table('expanded_pages')->insert(array('id' => '3','route_name' => 'volunteer','title' => 'ご協力のお願い','title_en' => 'ご協力のお願い','body' => <<<EOM
            ...
            EOM,'seq' => '3','open' => '1','created_at' => '2025-04-22 00:00:00','updated_at' => '2025-04-22 00:00:00'));
